...
function ReviewFilesList() {
    ...
    const resendFile = id => {
        setLoaded(false);
        api.post(`/reviewFiles/${id}`).then(res =>
            res.status === 200 ? fetchFiles() : console.log(res)
        );
    };

    useEffect(fetchFiles, []); //Uncomment this to enable fetching files from API
    // useEffect(() => {
    //   setFiles(reviewFilesData);
    //   setLoaded(true);
    // }, []);
    let thArray = [
        "id",
                                                    ...
                                                    <tr key={key}>
                                                        ...
                                                        <td>
                                                            <Link
                                                                ...
                                                                to={`/admin/locations/${file.location_id}`}
                                                            >
                                                                EG04
                                                                {
                                                                    file.location_id
